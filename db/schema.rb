...
ActiveRecord::Schema[7.1].define(version: 2024_08_28_200105) do
  ...
  create_table "galleries", force: :cascade do |t|
    ...
    t.index ["veiculo_id"], name: "index_galleries_on_veiculo_id"
  end
  ...
  add_foreign_key "galleries", "veiculos"
