...
function init_sidebar() {
  ...
  var setContentHeight = function () {
    ...
    // $('.right_col').css('min-height', "1785px");
  };
      ...
      switch (data.method) {
        ...
        case "getCroppedCanvas":
          if (result) {
            ...
            $("#salvar_cropped").click(function () {
              // if ( $(".image_current img")[0] ) {
              //   var image_current = $(".image_current img")[0].src;
              //     $(".image_current").hide();
              // }
              $(".image_current").hide();
              $(".box-image-cropped").html(result);
